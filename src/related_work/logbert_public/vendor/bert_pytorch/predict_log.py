...
class Predictor():
    ...
    def generate_test(output_dir, file_name, window_size, adaptive_window, seq_len, scale, min_len):
        ...
        # Keep variable-length test sequences indexable on newer NumPy versions.
    ...
    def predict(self):
        # Support both older and newer PyTorch checkpoint-loading semantics.
        model = _load_torch_checkpoint(self.model_path)
        ...
        if self.hypersphere_loss:
            center_dict = _load_torch_checkpoint(self.model_dir + "best_center.pt")
